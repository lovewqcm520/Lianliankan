package com.jack.view.view
{
	...
	import com.jack.view.panel.ChapterIcon;
	import com.jack.view.panel.SettingPanel;
	import com.jack.vo.ChapterVO;
	import com.jack.vo.gameModel.ClassicModelVO;
	...
	public class ClassicModelChapterView extends BaseView
	{
		...
		private function initialize1():void
		{
			...
			var voClassicModel:ClassicModelVO = new ClassicModelVO(100);
			voClassicModel.init();
			
			var len:int = voClassicModel.nLevel;
			var list:Vector.<ChapterVO> = voClassicModel.chapterList;
